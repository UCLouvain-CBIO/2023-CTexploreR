...
# 
# rm(p, i, k, tmp)
# save(nonCT_per_gene_CD4_datasets, 
#      file = "data_rmd/nonCT_per_gene_CD4_datasets.rda")

load("data_rmd/nonCT_per_gene_CD4_datasets.rda")

nonCT_meth_means_tmp <- sapply(nonCT_per_gene_CD4_datasets, rowMeans, na.rm = TRUE)
nonCT_meth_means <- Reduce(rbind, nonCT_meth_means_tmp) %>% 
  data.frame()
nonCT_meth_means$ensembl_gene_id <- names(nonCT_meth_means_tmp)
